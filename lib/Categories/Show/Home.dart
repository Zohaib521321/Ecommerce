...
class kitchen_show extends StatefulWidget {
  const kitchen_show({Key? key}) : super(key: key);

  @override
  State<kitchen_show> createState() => _kitchen_showState();
}

class _kitchen_showState extends State<kitchen_show> {
  @override
