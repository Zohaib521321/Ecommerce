...
class beauty_show extends StatefulWidget {
  const beauty_show({Key? key}) : super(key: key);

  @override
  State<beauty_show> createState() => _beauty_showState();
}

class _beauty_showState extends State<beauty_show> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:Text("Beauty And Personal Care"),
        centerTitle: true,
