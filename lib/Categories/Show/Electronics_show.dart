...
class electronic_show extends StatefulWidget {
  const electronic_show({Key? key}) : super(key: key);

  @override
  State<electronic_show> createState() => _electronic_showState();
}

class _electronic_showState extends State<electronic_show> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:Text("Electrnics"),
        centerTitle: true,
