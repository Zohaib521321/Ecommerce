...
class cloth_show extends StatefulWidget {
  const cloth_show({Key? key}) : super(key: key);

  @override
  State<cloth_show> createState() => _cloth_showState();
}

class _cloth_showState extends State<cloth_show> {
  @override
