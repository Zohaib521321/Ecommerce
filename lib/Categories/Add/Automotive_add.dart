...
class automative extends StatefulWidget {
  const automative({Key? key}) : super(key: key);

  @override
  State<automative> createState() => _automativeState();
}

class _automativeState extends State<automative> {
  File?_image;
  File?_image1;
                      ...
                      if (_image != null&&_image1!=null){
                        if(_selectedItem!=null){
                          storage.Reference reference = storage.FirebaseStorage
                              .instance.ref("Automotive/${DateTime
                              .now()
                          ...
                          ref.doc("product2").collection("Add_product").add({
                            "id": FirebaseAuth.instance.currentUser!.uid,
                            "product_name": namecontroller.text.toString(),
                            "product_price": pricecontroller.text.toString(),
                            "phonenumber": nocontroller.text.toString(),
